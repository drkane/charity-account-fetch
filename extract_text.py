...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="""Extract text from a PDF to a text file""")
    ...
    folder_parser = subparsers.add_parser('folder', help='Convert all PDF files in a folder to txt')
    folder_parser.add_argument('--source', default=".", help='Folder in which to look for PDFs')
